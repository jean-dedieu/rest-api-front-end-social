...
const UpdatePlayer = () => {
        ...
        setFormData(
          {
            ...
            description: {
              value: responseData.player.description,
              isValid: true
            }
          },
          true
  ...
  const playerUpdateSubmitHandler = async event => {
    ...
    try {
      ...
      history.push('/' + auth.academyId + '/players');
    } catch (err) {}
  };
  ...
  return (
    <React.Fragment>
      ...
      {!isLoading && loadedPlayer && (
        <form className="player-form" onSubmit={playerUpdateSubmitHandler}>
          <Input
            id="title"
            element="input"
            type="text"
          ...
          <Input
            ...
            onInput={inputHandler}
            initialValue={loadedPlayer.description}
            initialValid={true}
          />
